...
class QaPackageServiceTest {
    ...
    inner class CreateTests {
        ...
        @Test
        fun `should create package with valid command`() = runTest {
        ...
        @Test
        fun `should compute spec hash when specContent provided`() = runTest {
            val command = CreateQaPackageCommand(
                name = "Test Package",
                baseUrl = "https://api.example.com",
        ...
        @Test
        fun `should use default config when not provided`() = runTest {
            val command = CreateQaPackageCommand(
                name = "Test Package",
                baseUrl = "https://api.example.com",
                triggeredBy = "test-user"
        ...
        @Test
        fun `should use custom config when provided`() = runTest {
            val customConfig = QaPackageConfig(
                maxScenarios = 20,
    ...
    inner class FindByIdTests {
        ...
        @Test
        fun `should return package when found`() = runTest {
    ...
    inner class FindAllTests {
        ...
        @Test
        fun `should return paginated results`() = runTest {
        ...
        @Test
        fun `should return last page correctly`() = runTest {
            val packages = (1..25).map { createTestPackage(QaPackageId.generate(), name = "Package $it") }
        ...
        @Test
        fun `should return empty page when no packages`() = runTest {
    ...
    inner class FindByStatusTests {
        ...
        @Test
        fun `should return packages with matching status`() = runTest {
    ...
    inner class UpdateStatusTests {
        ...
        @Test
        fun `should update status when transition is valid`() = runTest {
            val id = QaPackageId.generate()
        ...
        @Test
        fun `should throw exception when package not found`() = runTest {
            val id = QaPackageId.generate()
        ...
        @Test
        fun `should throw exception for invalid status transition`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id, status = QaPackageStatus.REQUESTED)
        ...
        @Test
        fun `should allow transition to CANCELLED from any state`() = runTest {
            val id = QaPackageId.generate()
    ...
    inner class UpdateTests {
        ...
        @Test
        fun `should update package with provided fields`() = runTest {
            val id = QaPackageId.generate()
        ...
        @Test
        fun `should not change fields not in command`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(
                id,
                name = "Original Name",
    ...
    inner class SetCoverageTests {
        ...
        @Test
        fun `should set coverage report`() = runTest {
            val id = QaPackageId.generate()
    ...
    inner class SetQaSummaryTests {
        ...
        @Test
        fun `should set QA summary`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id)
    ...
    inner class MarkStartedTests {
        ...
        @Test
        fun `should set startedAt timestamp`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id)
    ...
    inner class MarkCompletedTests {
        ...
        @Test
        fun `should set completedAt timestamp and COMPLETE status`() = runTest {
            val id = QaPackageId.generate()
    ...
    inner class MarkFailedTests {
        ...
        @Test
        fun `should set failed status`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id)
        ...
        @Test
        fun `should throw exception for non-failure status`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id)
        ...
        @Test
        fun `should allow CANCELLED as failure status`() = runTest {
            val id = QaPackageId.generate()
            val existing = createTestPackage(id)
    ...
    inner class DeleteTests {
        ...
        @Test
        fun `should delete package and return true when exists`() = runTest {
            val id = QaPackageId.generate()
        ...
        @Test
        fun `should return false when package does not exist`() = runTest {
            val id = QaPackageId.generate()
    ...
    inner class CountTests {
        ...
        @Test
        fun `should return total count`() = runTest {
        ...
        @Test
        fun `should return count by status`() = runTest {
    ...
    inner class FindStreamTests {
        ...
        @Test
        fun `findAllStream should return flow of packages`() = runTest {
            val packages = listOf(
        ...
        @Test
        fun `findIncomplete should return flow of incomplete packages`() = runTest {
            val packages = listOf(
        ...
        @Test
        fun `findRecent should return packages since given time`() = runTest {
